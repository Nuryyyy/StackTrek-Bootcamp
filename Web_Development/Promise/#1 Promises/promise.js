...
const sortedByAge = datas.sort((a, b) => (a.age - b.age));
//console.log(sortedByAge)

//removed the minors
let adult = datas.filter(adult => adult.age >= 18);
//console.log(adult)

//#region
// First try in renaming
// const {fullName} = adult.every(unknown)
